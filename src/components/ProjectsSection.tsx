...
const defaultProjects: Project[] = [
  ...
  {
    id: "business-website-wix",
    title: "Business Website – Wix",
    description: "Built professional business websites for international clients, solving their online presence needs with SEO optimization and mobile-responsive design.",
    techStack: ["Wix", "SEO", "UI Customization"],
    link: "#",
